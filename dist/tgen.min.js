...
this,f=[],h={},l=0,g=null,e={shape:d.shapes,effects:Object.keys(d.effects),layers:[],normalize:c?c:"limitless"},k=function(){void 0==b&&(b=256);1>b&&(b=256);1>a&&(a=256);1024<b&&(b=1024);1024<a&&(a=1024);void 0==a&&(a=b);g=(b+a)/2};k();e.clear=function(){e.texture.clear();e.layers=[];f=[];l=0;h.start=(new Date).getTime();return e};e.buffer=function(c){this.data=null;this.components=4;this.width=b;this.height=a;this.wha=(this.width+this.height)/2;this.background=[0,0,0,255];"object"==typeof c&&(this.background=
...
" l"+e.layers.length+" i"+f.length);return{name:c,version:d.version,width:b,height:a,normalize:e.normalize,items:f}};e.render=function(c,f){e.event("beforeRender",c);var h=0;void 0!=c.width&&(b=c.width);void 0!=c.height&&(a=c.height);e.normalize=void 0!=c.normalize?c.normalize:"limitless";k();e.texture=new e.buffer(c.background);1!=f&&e.clear();for(var g in c.items){l=c.items[g][0];f=c.items[g][1];var m=c.items[g][2];"random"==f&&(f=t(e.defaults));"object"==typeof f&&(f=e.randItem(f));h!=l&&(void 0!=
...
!0);a.size=b.randByArray(a.size);for(var c=0;c<a.count;c++)b.shape.line(b,b.texture.width/2+Math.sin(c/a.freq1s*b.calc.pi)*a.size,b.texture.height/2+Math.cos(c/a.freq1c*b.calc.pi)*a.size,b.texture.width/2+Math.sin(c/a.freq2s*b.calc.pi)*a.size,b.texture.height/2+Math.cos(c/a.freq2c*b.calc.pi)*a.size);return a});g.effect("lines2",{blend:["opacity","lighten","screen"],rgba:"random",type:"vertical",size:[.1,11],count:[4,21],seed:[1,262140]},function(b,a){a.seed=b.randByArray(a.seed);b.calc.randomseed(a.seed);
for(var c=0;c<a.count;c++){var d=void 0!=a.elements?a.elements[c]:{size:b.randByArraySeed(a.size,!0),d:b.randRealSeed(.1,100)};"vertical"==a.type?b.shape.rect(b,b.percentX(d.d),0,b.percentX(d.size),b.texture.height):b.shape.rect(b,0,b.percentX(d.d),b.texture.width,b.percentX(d.size))}return a});g.effect("subplasma",{seed:[1,262140],size:[3,4],rgba:"random"},function(b,a){a.seed=b.randByArray(a.seed);a.size=b.randByArray(a.size);b.calc.randomseed(a.seed);var c=1<<a.size,d=b.texture.width,f=[],h,g;
c>d&&(c=d);var n=d/c;for(g=0;g<c;g++)for(h=0;h<c;h++)f[h*n+g*n*d]=b.calc.randomseed();for(g=0;g<c;g++)for(h=0;h<d;h++){var e=h&~(n-1),k=g*n*d;f[h+k]=b.calc.interpolate.catmullrom(f[(e-1*n&d-1)+k],f[(e-0*n&d-1)+k],f[(e+1*n&d-1)+k],f[(e+2*n&d-1)+k],h%n,n)}for(g=0;g<d;g++)for(h=0;h<d;h++)e=g&~(n-1),f[h+g*d]=b.calc.interpolate.catmullrom(f[h+(e-1*n&d-1)*d],f[h+(e-0*n&d-1)*d],f[h+(e+1*n&d-1)*d],f[h+(e+2*n&d-1)*d],g%n,n);for(h=0;h<b.texture.width;h++)for(g=0;g<b.texture.height;g++)c=255*f[h+g*d],b.point.rgba=
...
a.xchannel=b.randByArray(a.xchannel);a.ychannel=b.randByArray(a.ychannel);a.xlayer=b.randByArray(a.xlayer);a.ylayer=b.randByArray(a.ylayer);for(var c=new b.buffer,d=b.texture.width,f=b.texture.height,h=b.layers[a.xlayer],g=b.layers[a.ylayer],n=0;n<d;n++)for(var e=0;e<f;e++){var k=b.texture.offset(n,e),p=h[k+a.xchannel],q=g[k+a.ychannel];p=0==d%16?b.wrapx(n+(p*a.xamount*d>>16)):n+p*a.xamount*d/(d*d);q=0==f%16?b.wrapy(e+(q*a.yamount*f>>16)):e+q*a.yamount*f/(f*f);q=b.point.get(p,q);c.data[k]=q[0];c.data[k+
1]=q[1];c.data[k+2]=q[2];c.data[k+3]=q[3]}for(d=b.texture.size();d--;)b.texture.data[d]=c.data[d];return a});g.effect("clouds",{blend:"opacity",rgba:"random",seed:[1,262140],roughness:[2,16],colormap:null},function(b,a){a.seed=b.randByArray(a.seed);a.roughness=b.randByArray(a.roughness);var c=b.texture.width,d=b.texture.height,f=[],g=function(a,b,e){0>a&&(a=c+a);a>=c&&(a-=c);0>b&&(b=d+b);b>=d&&(b-=d);return void 0!==e?f[a][b]=e:f[a][b]},l=function(d){return(b.calc.randomseed()-.5)*(d/(c+c))*a.roughness},
n=function(e){var f=e/2;if(1>=f)return a;for(var h=f-f;h<=c+f;h+=f)for(var k=f-f;k<=d+f;k+=f){var q=g(h-f,k-f),p=g(h,k-f),y=g(h-f,k),v=g(h,k),w=h-f/2,x=k-f/2;v=g(w,x,b.calc.normalize1((q+p+y+v)/4+l(e)));g(h-f,x,b.calc.normalize1((q+y+v+g(h-e+f/2,x))/4+l(e)));g(w,k-f,b.calc.normalize1((q+p+v+g(w,k-e+f/2))/4+l(e)))}n(f)};b.calc.randomseed(a.seed);(function(){for(var a=0;a<=c;a++){f[a]=[];for(var b=0;b<=d;b++)f[a][b]=0}})();n(c);b.colormap.init(a.colormap,255,function(b){a.colormap=b});for(var e=0;e<
c;e++)for(var k=0;k<d;k++){var p=parseInt(255*f[e][k],10);b.point.rgba=null!==b.colormap.data?b.colormap.get(p,a.rgba):b.point.colorize(a.rgba,[p,p,p,255]);b.point.set(e,k)}return a});g.effect("colorbar",{type:"horizontal",mirror:!1,colormap:[{percent:0,rgba:[[0,255],[0,255],[0,255],255]},{percent:25,rgba:[[0,255],[0,255],[0,255],255]},{percent:50,rgba:[[0,255],[0,255],[0,255],255]},{percent:75,rgba:[[0,255],[0,255],[0,255],255]},{percent:100,rgba:[[0,255],[0,255],[0,255],255]}]},function(b,a){var c=
b.texture.width,d=b.texture.height;b.colormap.init(a.colormap,"horizontal"==a.type?c:d,function(b){a.colormap=b});if("horizontal"==a.type)for(var f=0;f<c;f++){if(a.mirror)var g=f<c/2?2*f:2*c-2*f;b.point.rgba=b.colormap.get(g);for(var l=0;l<d;l++)b.point.set(f,l)}else for(l=0;l<d;l++)for(a.mirror&&(g=l<d/2?2*l:2*d-2*l),b.point.rgba=b.colormap.get(g),f=0;f<c;f++)b.point.set(f,l);return a});g.effect("checkerboard",{size:[8,8],rgba:"randomalpha"},function(b,a){var c=b.texture.width,d=b.texture.height;
if("object"==typeof a.size)var f=a.size[0]=b.randByArray(a.size[0]),g=a.size[1]=b.randByArray(a.size[1]);else g=f=a.size;for(var l=c/f,n=d/g,e=function(a,e){for(var f=0;f<l;f++)for(var g=0;g<n;g++)f+a<c&&g+e<d&&b.point.set(f+a,g+e)},k=0;k<f;k++)if(0==k%2)for(var p=0;p<g;p++)0==p%2?e(k*l,p*n):e(k*l+l,p*n);return a});g.effect("dots",{blend:"opacity",gridX:[1,32],gridY:[1,32],size:[10,250],seed:[1,262140],rgba:"randomalpha",shape:"rect",dynamic:!0,xsines:[1,12],ysines:[1,12]},function(b,a){a.gridX=b.randByArray(a.gridX);
a.gridY=b.randByArray(a.gridY);a.seed=b.randByArray(a.seed);void 0===a.xsines?a.xsines=b.randInt(1,10):"object"==typeof a.xsines&&(a.xsines=b.randInt(a.xsines[0],a.xsines[1]));void 0===a.ysines?a.ysines=b.randInt(1,10):"object"==typeof a.ysines&&(a.ysines=b.randInt(a.ysines[0],a.ysines[1]));b.calc.randomseed(a.seed);for(var c=b.randByArraySeed(a.size)/100,d=b.texture.width/a.gridX,f=b.texture.height/a.gridY,g=d/2,l=f/2,n=1;n<=a.gridX;n++)for(var e=1;e<=a.gridY;e++){var k=c*(d+f)/2/2;k=k-k/2*Math.sin(n/
a.gridX*a.xsines*2*b.calc.pi)+k/2*Math.sin(e/a.gridY*a.ysines*2*b.calc.pi);switch(a.shape){case "sphere":b.shape.sphere(b,n*d-g,e*f-l,2*k,!0,a.rgba,a.dynamic);break;case "pyramid":b.shape.pyramid(b,n*d-g,e*f-l,k,k,!0,a.rgba,a.dynamic);break;case "rect":b.shape.rect(b,n*d-g,e*f-l,k,k,!0,a.rgba,a.dynamic);break;default:k/=2,b.shape.circle(b,n*d-g,e*f-l,k,!0)}}return a})})("tgen");(function(g){g=window[g];g.effect("opacity",{adjust:128},function(b,a){b.walk(function(b){b[3]=a.adjust;return b});return a});g.effect("vibrance",{adjust:50},function(b,a){var c=-1*a.adjust;b.walk(function(a){var b=Math.max(a[0],a[1],a[2]),d=2*Math.abs(b-(a[0]+a[1]+a[2])/3)/255*c/100;a[0]!==b&&(a[0]+=(b-a[0])*d);a[1]!==b&&(a[1]+=(b-a[1])*d);a[2]!==b&&(a[2]+=(b-a[2])*d);return[a[0],a[1],a[2],a[3]]});return a});g.effect("brightness",{adjust:50,legacy:!0},function(b,a){!0===a.legacy?b.walk(function(b){return[Math.min(b[0]+
...
1,1,1]},function(b,a){if("object"!=typeof a.weights||null==a.weights)return a;var c=new b.buffer;c.clear();for(var d=Math.round(Math.sqrt(a.weights.length)),f=Math.floor(d/2),g=a.transparent?1:0,l=0;l<b.texture.height;l++)for(var n=0;n<b.texture.width;n++){for(var e=0,k=0,p=0,q=0,t=0;t<d;t++)for(var m=0;m<d;m++){var r=a.weights[t*d+m],u=b.texture.get(n+m-f,l+t-f);e+=u[0]*r;k+=u[1]*r;p+=u[2]*r;q+=u[3]}c.set(n,l,[e,k,p,q+g*(255-q)])}for(d=b.texture.size();d--;)b.texture.data[d]=c.data[d];return a})})("tgen");(function(g){g=window[g];g.shape("rect",function(b,a,c,d,f,g){void 0!==g&&(a-=parseInt(d/2,10),c-=parseInt(f/2,10));for(g=0;g<d;g++)for(var h=0;h<f;h++)b.point.set(a+g,c+h)});g.shape("circle",function(b,a,c,d,f){void 0==f&&(a+=d,c+=d);for(f=-d;f<d;f++)for(var g=Math.round(Math.sqrt(d*d-f*f)),l=-g;l<g;l++)b.point.set(a+f,c+l)});g.shape("line",function(b,a,c,d,f){var g=Math.sqrt((d-a)*(d-a)+(f-c)*(f-c));d=(d-a)/g;f=(f-c)/g;for(var l,n,e=0;e<g;e++)l=a+d*e,n=c+f*e,b.point.set(l,n)});g.shape("sphere",
function(b,a,c,d,f,g,l){void 0==f&&(a+=d,c+=d);for(f=-d;f<d;f++)for(var h=parseInt(Math.sqrt(d*d-f*f),10),e=-h;e<h;e++){var k=Math.min(255,Math.max(0,255-255*Math.sqrt(e*e+f*f)/(d/2)))/255;0<k&&(b.point.rgba=[g[0]*k,g[1]*k,g[2]*k,l?255*k:g[3]],b.point.set(a+f,c+e))}});g.shape("pyramid",function(b,a,c,d,f,g,l,n){var e=parseInt(d/2,10),h=parseInt(f/2,10);1!=g&&(a+=e,c+=h);for(g=-e;g<e;g++)for(var p=-h;p<h;p++){var q=255*(.25-Math.abs(g/d))+255*(.25-Math.abs(p/f));1<q&&(b.point.rgba=[l[0]/255*q,l[1]/
255*q,l[2]/255*q,n?q:l[3]],b.point.set(a+g,c+p))}})})("tgen");
